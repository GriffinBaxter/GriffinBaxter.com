...
export default function Navbar({ currentPage }: Props) {
  const links = (
    <ul
      tabIndex={0}
      className="menu dropdown-content z-1 w-52 menu-sm rounded-box bg-base-100 px-1 max-md:dropdown-content max-md:shadow-sm md:menu-horizontal md:w-auto md:menu-md md:bg-transparent"
    >
  ...
  return (
    <div className="mb-10 w-full bg-neutral">
      <div className="navbar mx-auto max-w-300 bg-neutral text-neutral-content">
